...
export interface FastUpdateMessage {
  ...
  y: number;
  t: number;
  totalSnakes: number; // Total number of snakes in the entire game world
  leaderboard: LeaderboardEntry[]; // Top snakes sorted by length
  playerRank: number; // Player's exact rank in the game
}
